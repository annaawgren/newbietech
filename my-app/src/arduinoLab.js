...
class ArduinoLab extends Component {
  render() {
    return (
      <div
        className="arduino flex flex-row w-100 pr6 pl6 tl justify-end"
        id="arduino"
      >
        <div className="labtxt-container-black flex flex-column">
          <div className="labnumber-hl-black mb4">t.b.a</div>
          <div className="labtxt-hl-black">Build interactive</div>
          <div className="labtxt-hl-black">wearables with Arduino</div>
          ...
          <p>
            ...
            using micro-controllers and Arduino. Bring your own laptop. No prior
