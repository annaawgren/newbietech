...
class MachineLearning extends Component {
  ...
  render() {
    return (<div className="prelaunch flex flex-column w-100 tl pl6 items-start" id="machinelearning">



      <div className="labtxt-container flex flex-column justify-center">
