...
class Header extends Component {
  ...
  render() {
    return (
      <div
        className="header flex flex-column w-100 pt4 pl6 pr6 pb5 tr"
        id="header"
      >
        <div className="mobileMenu-container">
          <div
            onClick={this.handleMenuClick}
            className="mobile-menu flex flex-row item-end w-100 mb5"
          >
            <span className="underlined">Menu</span>
          </div>
          <div
            className={`contact-info ${
              this.state.mobileMenuVisible ? "visible" : "hidden"
            }`}
          >
