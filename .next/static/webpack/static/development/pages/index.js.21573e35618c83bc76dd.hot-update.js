...
var Shapes = function Shapes(props) {
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    var createShape = function createShape(x, y) {
      return Bodies.circle(x, y, 20, 20, {
        // frictionAir: 0.1,
        render: {
    ...
    }; // const newbieLogo = Bodies.rectangle(50, 50, 300, {
    //   render: {
    //     sprite: {
    //       texture: "../static/images/newbielogo.png"
    //     }
    ...
    World.add(engine.world, [ground, ceiling, leftWall, rightWall, mouseControl, initialShapes, rectangleGreen, rectanglePink, circle]); // document.addEventListener("click", event => {
...
//# sourceMappingURL=index.js.21573e35618c83bc76dd.hot-update.js.map