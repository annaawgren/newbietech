...
var Shapes = function Shapes(props) {
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    var scrollControl = MouseConstraint.mouse.element.removeEventListener("mousewheel", MouseConstraint.mouse.mousewheel);
    var scrollControlAlso = MouseConstraint.mouse.element.removeEventListener("DOMMouseScroll", MouseConstraint.mouse.mousewheel); // const initialShapes = Composites.stack(50, 50, 15, 3, 100, 150, (x, y) => {
    //   return createShape(x, y);
    // });

    World.add(engine.world, [ground, ceiling, leftWall, rightWall, mouseControl, // initialShapes,
    rectangle, circle, newbieLogo, scrollControl, scrollControlAlso]); // document.addEventListener("click", event => {
...
//# sourceMappingURL=index.js.32fffabcd9f7f41da63d.hot-update.js.map