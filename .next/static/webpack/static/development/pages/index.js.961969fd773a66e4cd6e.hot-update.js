...
var Header = function Header(props) {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("header", {
    className: "fixed w-full bg-lightpink p-20 relative z-10 flex flex-row justify-between",
    __source: {
    ...
    className: "flex flex-col h-8 justify-between",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 16
    },
...
//# sourceMappingURL=index.js.961969fd773a66e4cd6e.hot-update.js.map