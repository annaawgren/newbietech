...
var Shapes = function Shapes(props) {
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    var rightWall = Bodies.rectangle(w + 50, h / 2, 100, h + 100, wallOptions); // const mouseScrollOne = Mouse.create(engine, {
    //   element: removeEventListener("mousewheel", mouse.mousewheel)
    // });
    // const mouseScollTwo = Mouse.create(engine, {
    ...
    console.log(MouseConstraint); // const initialShapes = Composites.stack(50, 50, 15, 3, 100, 150, (x, y) => {
...
//# sourceMappingURL=index.js.be631cf7df739598e70f.hot-update.js.map