...
var Shapes = function Shapes(props) {
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    var mouseScrollOne = Mouse.create(engine, {
      element: removeEventListener("mousewheel", mouse.mousewheel)
    });
    var mouseScollTwo = Mouse.create(engine, {
    ...
    rectangle, circle, newbieLogo, mouseScollTwo, mouseScrollOne]); // document.addEventListener("click", event => {
...
//# sourceMappingURL=index.js.32d981fced62ed8a0eda.hot-update.js.map