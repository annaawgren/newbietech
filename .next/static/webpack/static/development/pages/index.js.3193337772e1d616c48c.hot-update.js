...
var Header = function Header(props) {
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("header", {
    className: "jsx-56697890" + " " + "fixed w-full p-20 z-10 flex flex-row justify-between",
    __source: {
    ...
    className: "jsx-56697890" + " " + "ham flex flex-col h-6 justify-between",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 16
    },
    ...
    className: "jsx-56697890" + " " + "hamline",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 17
    },
    ...
    className: "jsx-56697890" + " " + "hamline middle",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 18
    },
